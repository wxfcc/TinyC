#ifndef __FUNCTION_X64_WINDOWS_H__
#define __FUNCTION_X64_WINDOWS_H__
#include "Label.h"
#include "JITEngine.h"
// in x64 mode, just only support __fastcall calling convention 
class FunctionX64Windows :public Function {
public:
    FunctionX64Windows(JITEngine* parent, char* codeBuf);
    ~FunctionX64Windows();
